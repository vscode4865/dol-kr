...
function trinit_creatureTentacle()
{
	if (!setup.trCreatures.tentacle)
	{
		setup.trCreatures.tentacle = [
			...
			{name:"shoot",koName:"가지",post:1,plural:"shoots"},
			{name:"tendril",koName:"덩굴",post:2,plural:"tendrils"},
			{name:"vine",koName:"줄기",post:1,plural:"vines"},
            ...
            {name:"throbbing",koName:"꿈틀거리는",post:-1,plural:"throbbing"},
            {name:"slick",koName:"매끄러운",post:-1,plural:"slick"},
            {name:"moist",koName:"촉촉한",post:-1,plural:"moist"},
            {name:"quivering",koName:"떨고 있는",post:-1,plural:"quivering"},
            {name:"sodden",koName:"흠뻑 젖은",post:-1,plural:"sodden"},
            {name:"shivering",koName:"덜덜 떠는",post:-1,plural:"shivering"},
            {name:"shuddering",koName:"흔들거리는",post:-1,plural:"shuddering"},
            {name:"convulsing",koName:"경련하는",post:-1,plural:"convulsing"},
            {name:"undulating",koName:"오르락내리락 하는",post:-1,plural:"undulating"},
            {name:"damp",koName:"축축한",post:-1,plural:"damp"},
            {name:"bulbous",koName:"주먹만한",post:-1,plural:"bulbous"},
            {name:"gyrating",koName:"빙빙 도는",post:-1,plural:"gyrating"},
            {name:"large",koName:"커다란",post:-1,plural:"large"},
            {name:"bumpy",koName:"울퉁불퉁한",post:-1,plural:"bumpy"},
            {name:"thin",koName:"얇은",post:-1,plural:"thin"},
            {name:"narrow",koName:"가느다란",post:-1,plural:"narrow"},
